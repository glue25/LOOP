...
if __name__=='__main__':
    ...
    parser.add_argument("--env", default="MBRLSwimmer-v0")
    ...
    parser.add_argument("--logdir", type = str, default = "logs/test/Swimmer_test_model/loop/")
